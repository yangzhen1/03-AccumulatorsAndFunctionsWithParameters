...
def run_test_sum_of_digits():
    ...
    # -------------------------------------------------------------------------
    expected = 25
    answer = sum_of_digits(29248)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    expected = 29
    answer = sum_of_digits(732575)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    expected = 47
    answer = sum_of_digits(23456765432)
...
def run_test_digits_in_power():
    ...
    expected = 17
    answer = digits_in_power(23,3)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    expected = 27
    answer = digits_in_power(234,3)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    expected = 34
    answer = digits_in_power(2345,2)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)
